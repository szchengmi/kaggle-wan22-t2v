...
!rm /tmp/gguf.zip
!curl -sL "https://github.com/Kinkariari/WanVideoWrapper/archive/refs/heads/main.zip" -o /tmp/wvw.zip
!unzip -qo /tmp/wvw.zip -d custom_nodes/
!mv custom_nodes/WanVideoWrapper-main custom_nodes/WanVideoWrapper
!rm /tmp/wvw.zip
!ls custom_nodes/
print("cell1_done")
